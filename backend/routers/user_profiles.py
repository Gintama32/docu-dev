...
@router.get("/user-profiles/{profile_id}/experiences", response_model=List[schemas.ProfileExperience])
...
@router.post("/user-profiles/{profile_id}/experiences", response_model=schemas.ProfileExperience)
...
@router.put("/user-profiles/{profile_id}/experiences/{experience_id}", response_model=schemas.ProfileExperience)
def update_profile_experience(
    ...
    if not existing or existing.user_profile_id != profile_id:
        raise HTTPException(status_code=404, detail="Experience not found for this profile")
...
@router.get("/user-profiles/{profile_id}/skills", response_model=List[schemas.ProfileSkill])
...
def create_profile_skill(
    profile_id: int, 
    skill: schemas.ProfileSkillCreate, 
    db: Session = Depends(get_db)
):
...
@router.put("/user-profiles/{profile_id}/skills/{skill_id}", response_model=schemas.ProfileSkill)
...
@router.get("/user-profiles/{profile_id}/certifications", response_model=List[schemas.ProfileCertification])
...
@router.post("/user-profiles/{profile_id}/certifications", response_model=schemas.ProfileCertification)
...
@router.put("/user-profiles/{profile_id}/certifications/{certification_id}", response_model=schemas.ProfileCertification)
def update_profile_certification(
    ...
    if not existing or existing.user_profile_id != profile_id:
        raise HTTPException(status_code=404, detail="Certification not found for this profile")
    
    updated = crud.update_profile_certification(db, certification_id, certification_update)
    if not updated:
...
@router.get("/user-profiles/{profile_id}/educations", response_model=List[schemas.ProfileEducation])
...
@router.post("/user-profiles/{profile_id}/educations", response_model=schemas.ProfileEducation)
...
@router.put("/user-profiles/{profile_id}/educations/{education_id}", response_model=schemas.ProfileEducation)
def update_profile_education(
    ...
    if not existing or existing.user_profile_id != profile_id:
        raise HTTPException(status_code=404, detail="Education entry not found for this profile")
...
def reorder_profile_educations(
    ...
    if not ok:
        raise HTTPException(status_code=400, detail="Failed to reorder education entries")
    return {"success": True}
