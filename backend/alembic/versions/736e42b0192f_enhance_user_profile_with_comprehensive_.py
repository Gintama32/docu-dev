...
def upgrade() -> None:
    ...
    op.add_column('user_profiles', sa.Column('full_name', sa.String(200), nullable=True))
    op.add_column('user_profiles', sa.Column('current_title', sa.String(200), nullable=True))
    
    # Add employment information columns
    op.add_column('user_profiles', sa.Column('department', sa.String(100), nullable=True))
    op.add_column('user_profiles', sa.Column('employee_type', sa.String(50), nullable=True))
    op.add_column('user_profiles', sa.Column('is_current_employee', sa.Boolean(), server_default='true', nullable=True))
    ...
    op.add_column('user_profiles', sa.Column('about_url', sa.String(500), nullable=True))
    
    # Add JSON collections columns
    op.add_column('user_profiles', sa.Column('certifications', sa.JSON(), server_default='[]', nullable=True))
    op.add_column('user_profiles', sa.Column('skills', sa.JSON(), server_default='[]', nullable=True))
    op.add_column('user_profiles', sa.Column('education', sa.JSON(), server_default='[]', nullable=True))
    ...
    op.create_index('ix_profile_experiences_user_profile_id', 'profile_experiences', ['user_profile_id'])
    op.create_index('ix_profile_experiences_display_order', 'profile_experiences', ['user_profile_id', 'display_order'])
